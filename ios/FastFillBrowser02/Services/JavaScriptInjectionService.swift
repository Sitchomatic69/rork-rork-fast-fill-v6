            ...
            try {
                ...
                var send = function() {
                    try {
                        ...
                        var hasSuccess = !!document.querySelector('.ol-alert__content--status_success, .ol-alert__content.ol-alert__content--variant_global.ol-alert__content--status_success.multi-line');
                        var path = window.location.pathname || '/';
